  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-8 animate-fade-in">
      ...
      <button
        ...
        className="w-full bg-gold-gradient text-on-primary font-label text-[10px] tracking-[0.3em] uppercase py-6 rounded-lg shadow-2xl shadow-primary/30 hover:scale-[1.05] active:scale-95 transition-all duration-500 font-bold flex justify-center items-center gap-2"
      >
        {isProcessing ? (
          <>
