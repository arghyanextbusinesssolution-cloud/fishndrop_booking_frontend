...
export const NavBar = () => {
  ...
  return (
    <header className="fixed top-0 w-full z-50 flex justify-between items-center px-2 md:px-4 py-2 md:py-4 bg-[#0F3D2E]/90 backdrop-blur-xl border-b border-[#C8A96A]/20 shadow-[0_0_20px_rgba(200,169,106,0.1)]">
